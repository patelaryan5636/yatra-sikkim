...
<head>
  ...
  <style>
    ...
    body {
      ...
      background-image: radial-gradient(at 80% 0%,
          #c4dfdf 0px,
          transparent 50%),
...
<body class="">
  ...
  <div class="max-w-8xl mx-10 my-16 ">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div class="space-y-6">
          <div class="bg-[#c4dfdf]/20 rounded-2xl p-6">
            <div class="flex items-start gap-4">
              <div class="bg-[#c4dfdf] rounded-full p-3 w-12 h-12 flex items-center justify-center shrink-0">
          ...
          <div class="bg-[#c4dfdf]/20 rounded-2xl p-6">
            <div class="flex items-start gap-4">
              <div class="bg-[#c4dfdf] rounded-full p-3 w-12 h-12 flex items-center justify-center shrink-0">
                <i class="fas fa-exclamation-triangle text-[#648383] text-xl"></i>
              </div>
              <div>
                <h3 class="text-lg font-semibold text-[#648383] mb-2">
                  Emergency & Safety
      ...
      <div class="card rounded-3xl p-8">
        <h2 class="text-2xl font-semibold text-[#648383] mb-6 flex items-center gap-2">
        ...
        <form action="contactus_process.php" method="post" class="space-y-6" id="contactForm">
          <div>
            ...
            <input type="text" id="name" name="name" class="input-field w-full px-4 py-3 rounded-xl focus:outline-none"
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input type="email" id="email" name="email"
                class="input-field w-full px-4 py-3 rounded-xl focus:outline-none" placeholder="Enter your email"
                required />
            </div>
            <div>
              ...
              <input type="tel" id="phone" name="phone"
                class="input-field w-full px-4 py-3 rounded-xl focus:outline-none" placeholder="Enter your phone"
                required />
            </div>
          </div>

          <div>
            <label class="block text-gray-600 text-sm font-medium mb-2" for="subject">
              What can we help you with?
            </label>
            <select id="subject" name="subject" class="input-field w-full px-4 py-3 rounded-xl focus:outline-none"
              required>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label class="block text-gray-600 text-sm font-medium mb-2" for="travelDate">
            ...
            <div>
              <label class="block text-gray-600 text-sm font-medium mb-2" for="groupSize">
                Group Size
              </label>
        ...
        <!-- Map Section -->
        <div class="mt-8">
          <h3 class="text-lg font-semibold text-[#648383] mb-4 flex items-center gap-2">
            <i class="fas fa-map-marker-alt"></i>
            Find Us in Sikkim
          </h3>
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d113677.29410931207!2d88.55599026774635!3d27.330836952737636!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39e6a5b99e7428f5%3A0xc391107c13256a9e!2sGangtok%2C%20Sikkim!5e0!3m2!1sen!2sin!4v1709461159932!5m2!1sen!2sin"
            class="w-full h-52 rounded-xl border-2 border-[#c4dfdf]/30" style="border: 0" allowfullscreen=""
            loading="lazy">
          </iframe>
        </div>
        ...
        <div class="mt-8">
          ...
          <div class="bg-[#c4dfdf]/10 rounded-lg p-3 text-center">
            <i class="fas fa-city text-[#94c4c4] text-2xl mb-2"></i>
            <p class="text-sm text-gray-600 font-medium">Gangtok</p>
          </div>
          <div class="bg-[#c4dfdf]/10 rounded-lg p-3 text-center">
            <i class="fas fa-water text-[#94c4c4] text-2xl mb-2"></i>
            <p class="text-sm text-gray-600 font-medium">Tsomgo Lake</p>
          </div>
          <div class="bg-[#c4dfdf]/10 rounded-lg p-3 text-center">
            <i class="fas fa-flag text-[#94c4c4] text-2xl mb-2"></i>
            <p class="text-sm text-gray-600 font-medium">
              Nathula Pass
            </p>
          </div>
          <div class="bg-[#c4dfdf]/10 rounded-lg p-3 text-center">
            <i class="fas fa-mountain-sun text-[#94c4c4] text-2xl mb-2"></i>
            <p class="text-sm text-gray-600 font-medium">Pelling</p>
          </div>
          <div class="bg-[#c4dfdf]/10 rounded-lg p-3 text-center">
            <i class="fas fa-place-of-worship text-[#94c4c4] text-2xl mb-2"></i>
            <p class="text-sm text-gray-600 font-medium">
              Rumtek Monastery
            </p>
          </div>
          <div class="bg-[#c4dfdf]/10 rounded-lg p-3 text-center">
            <i class="fas fa-spa text-[#94c4c4] text-2xl mb-2"></i>
            <p class="text-sm text-gray-600 font-medium">Yumthang Valley</p>
          </div>
        </div>
        </div>
      </div>
