...
<body>
  <h1 class="absolute left-32 top-14 text-5xl font-bold text-gray-800">
    Fairs & Festivals - The Life of Sikkim
  </h1>
  ...
  <div class="flex items-center justify-center h-screen">
    <div class="max-w-5xl w-full h-[65vh] flex bg-white shadow-lg rounded-xl overflow-hidden mt-20">
        ...
        <div class="swiper mySwiper h-full">
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <img src="../assets/img/festivals/saga-dawa-festival_sikkim.png" class="w-full h-full object-cover" alt="Festival 1" />
            </div>
            <div class="swiper-slide">
              <img src="../assets/img/festivals/Losoong_Sikkim.png" class="w-full h-full object-cover" alt="Festival 2" />
            </div>
            <div class="swiper-slide">
              <img src="../assets/img/festivals/Dasain_Sikkim.png" class="w-full h-full object-cover" alt="Festival 3" />
            </div>
            <div class="swiper-slide">
              <img src="../assets/img/festivals/Tendong Lho Rum Faat.png" class="w-full h-full object-cover" alt="Festival 3" />
            </div>
          </div>
        </div>
      </div>
  ...
  <script>
    const festivals = [
      {
        title: "Saga Dawa",
        date: "May - June (Full moon day)",
        desc: "Experience this sacred Buddhist festival marking the birth, enlightenment, and death of Lord Buddha, celebrated with monastery processions and butter lamp offerings.",
      },
      {
        title: "Losoong/Namsoong",
        date: "December",
        desc: "Witness the Sikkimese New Year with vibrant Cham dances by monks, traditional archery competitions, and feasting that marks the end of the harvest season.",
      },
      {
        title: "Dasain (Dashain)",
        date: "September - October",
        desc: "Join the Hindu Nepali community in celebrating the victory of good over evil with family gatherings, flying kites, and receiving blessings with 'tika' on the forehead.",
      },
      {
        title: "Tendong Lho Rum Faat",
        date: "August",
        desc: "Celebrate this ancient Lepcha festival offering prayers to the sacred Tendong Hill, believed to have saved the tribe from a great flood, with cultural programs and rituals.",
      },
    ];
