  ...
  <body>
    ...
    <div class="text-center my-4">
      ...
      <p class="text-lg text-gray-600 mt-2 max-w-6xl mx-auto">
        Experience the future of travel with our AI-driven recommendation system! Get personalized place suggestions in Sikkim state based on your interests and preferences powered by smart algorithms for the best experience.
      </p>
  </div>
        ...
        <div id="results" class="hidden">
          <div class="flex justify-between items-center mb-6">
            <h2 class="text-3xl font-bold text-gray-800">
              ✨ Your Personalized Sikkim Journey
            </h2>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (dateElement) {
      ...
      document
        ...
        .addEventListener("click", async function () {
          ...
          try {
            ...
            const prompt = `You are a Sikkim travel expert. Suggest 3 amazing places in Sikkim state, India that match these preferences:
      ...
      function sharePlace(name, description) {
        const shareText = `Check out ${name} in Sikkim! ${description}`;
      ...
      function downloadItinerary() {
        ...
        let content = "Sikkim TRAVEL ITINERARY\n";
        ...
        a.href = url;
        a.download = 'Sikkim-travel-plan.txt';
