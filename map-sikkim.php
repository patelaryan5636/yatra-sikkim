...
<body>
    <h1 class="title font-bold text-gray-700 mb-2 text-5xl text-center mt-10">
        explore & discover: sikkim
    </h1>
    <p class="text-gray-600 text-xl font-serif px-20 text-center">
        Discover the serene beauty and spiritual heart of Sikkim. From sacred
        lakes and majestic mountain passes to ancient monasteries and lush
        valleys, embark on a journey through its breathtaking landscapes and rich
        cultural heritage.
    </p>

    <div class="flex justify-center items-center gap-5 mb-8 font-serif">
        <div class="px-3 py-4 mt-3 bg-cyan-100 h-6 text-gray-600 font-medium rounded-lg flex items-center">
            🏔️ Mountain Peaks & Passes
        </div>
        <div class="px-3 py-4 mt-3 bg-lime-100 h-6 text-gray-600 font-medium rounded-lg flex items-center">
            🧘‍♂️ Spiritual Sites
        </div>
