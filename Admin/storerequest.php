...
$stmt = $conn->prepare("SELECT * FROM `store_master` WHERE `is_confirmed` = 0");
$stmt->execute();
                            ...
                            <table class="table  datanew">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <?php 
                                                echo $stores['owner_name']; 
                                            ?>
                                        </td>
                                        <td>
                                            <?php 
                                                echo $stores['owner_mobile_number']; 
                                            ?>
                                        </td>
                                        <td>
                                            <?php 
                                                echo $stores['owner_email']; 
                                            ?>
                                        </td>
                                        <td>
                                            <?php 
                                                echo $stores['store_type']; 
                                            ?>
                                        </td>
                                        <td>
                                            <?php 
                                                $workingDays = explode(",", $stores['business_days']);
                                                echo "<ul>";
                                        ...
                                        <td>
                                            <?php
                                                echo "<a class='me-3' href=store_req_details.php?id=".encryptId($stores['store_id']).">
                                        ...
                                        <td>
                                            <form action="store_status_update.php" method="POST" style="display:inline;">
                                                <input type="hidden" name="id" value="<?php echo $stores['store_id'];?>">
                                            ...
                                            <?php
                                            echo "<a class='me-3' href='store_status_update.php?action=delete&id={$stores['store_id']}' id='disableBtn'>
