...
$query = "SELECT * FROM `guide_master` WHERE guide_id = '$id' AND is_confirm = 0";
    ...
    $aadhar = $guidedata['aadhar_card_number'];
    $pan_card = $guidedata['pan_card_number'];
    $guide_licence = $guidedata['guide_license_number'];
    ...
    $aadhar_doc = $guidedata['aadhar_card_document'];
    $pan_doc = $guidedata['pan_card_document'];
    $license_doc = $guidedata['training_certifications'];
                                ...
                                <div class="slider-product-details">
                                    <div class="owl-carousel owl-theme product-slide">
                                        <div class="slider-product">
                                            <img src="../uploads/guides_documents/<?php echo $photo; ?>" alt='img'>
                                            <h4>Guide Image</h4>
                                        </div>
                                        <div class="slider-product">
                                            <img src="../uploads/guides_documents/<?php echo $aadhar_doc; ?>" alt='img'>
                                            <h4>AADHAR CARD</h4>
                                        </div>
                                        <div class="slider-product">
                                            <img src="../uploads/guides_documents/<?php echo $pan_doc; ?>" alt='img'>
                                            <h4>PAN CARD</h4>
                                        </div>
                                        <div class="slider-product">
                                            <img src="../uploads/guides_documents/<?php echo $license_doc; ?>" alt='<?php
                                            echo $license_doc; ?>'>
                                            <h4>GUIDE LICENSE</h4>
                                            
                                        </div>
                                        <!-- <div class="slider-product">
                                            <img src="../assets/img/gandiv_logo.png" alt='img'>
                                            <h4>Document 4</h4>
                                        </div> -->
                                    </div>
                                    <!-- <?php
